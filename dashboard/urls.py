...
urlpatterns = [
    ...
    path("administrador/agendamentos/novo", views.create_agendamento, name="create_event"),
    # path("administrador/agendamentos/editar/<int:pk>", views.EventEdit.as_view(), name="event_edit"),
    path('administrador/agendamentos/deletar/<int:event_id>', views.delete_agendamento, name='delete_event'),
