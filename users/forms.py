...
class RegistroForm(forms.ModelForm):
    ...
    def clean_telefone(self):
        ...
        if (
            Paciente.objects.filter(telefone=telefone).exists()
            or Medico.objects.filter(telefone=telefone).exists()
        ):
